...
happyExpList = Happy_Data_Array.listArray (0,119) ([17280,3088,16,0,0,0,16798,0,0,0,0,0,0,33308,32864,4163,12,128,0,0,0,1028,13248,10,1912,57345,1040,7171,24706,17280,3088,2160,386,16654,49200,2081,6,32768,0,0,768,0,96,0,0,32768,97,0,0,1024,0,0,0,8327,24,32768,0,64,0,0,0,32,16654,48,0,0,32768,30720,390,4320,772,0,0,33596,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","Exp","RecordField","Record","RecordFieldList","num","true","false","'+'","'*'","\"&&\"","\"||\"","'('","')'","\"==\"","\"!=\"","'{'","'}'","'if'","'then'","'else'","'.'","':'","','","'record'","id","%eof"]
        bit_start = st * 29
        bit_end = (st + 1) * 29
...
action_11 (20) = happyShift action_32
action_11 (28) = happyShift action_33
action_11 (5) = happyGoto action_30
action_11 (7) = happyGoto action_31
...
action_36 (5) = happyGoto action_30
...
action_37 (23) = happyShift action_38
...
happyReduction_13 (HappyTerminal (TokenId happy_var_3))
	_
	(HappyAbsSyn4  happy_var_1)
	 =  HappyAbsSyn4
		 (AccessRecord happy_var_1 (Var happy_var_3)
	)
...
happyReduction_15 (HappyAbsSyn4  happy_var_3)
	...
	(HappyTerminal (TokenId happy_var_1))
	 =  HappyAbsSyn5
		 (RecordField (Var happy_var_1) happy_var_3
	)
